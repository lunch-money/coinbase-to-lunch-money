...
export declare type CoinbaseData = Record<string, string> | string;
...
export declare type CoinbaseRequestHandlerResponse = AxiosResponse | AxiosError['response'];
export declare type CoinbaseResult = {
    pagination?: {
